...
<head>
    ...
    <title>US MUSIC SHOP - LOGIN</title>
...
<body>
    ...
    <div id="frame">
        <h3 id="title">US MUSIC SHOP - LOGIN</h3>
        <div>
    ...
    <script>
        ...
        document.getElementById("create").addEventListener('click', function() {
            window.location.replace("createpage.php");
        })
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState == 4 && xhr.status == 200) {
                        ...
                        if (response == "success") { //successfully logged in
                            ...
                            document.getElementById("warning").innerHTML = "Invalid login, please login again.";
                            document.getElementById("warning").style = "display:block";
                            setTimeout(function() {
